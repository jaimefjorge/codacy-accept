...
export function generateHtmlReport(result) {
    ...
    if (result.spec.metadata?.priority) {
        const priorityColors = { critical: '#991b1b', high: '#b45309', medium: '#1d4ed8', low: '#6b7280' };
        const priorityBgs = { critical: '#fee2e2', high: '#fef3c7', medium: '#dbeafe', low: '#f3f4f6' };
...
export function saveHtmlReport(result) {
